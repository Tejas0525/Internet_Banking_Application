...
import './AddBankForm.css'; // Optional CSS styling
...
const AddBankForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      try {
        const response = await axios.post('http://localhost:8080/api/banks', formData);
        ...
        alert('Failed to add bank. Please check the server and try again.');
      }
    }
  };
